...
\usepackage[utf8]{inputenc}     % << Required for inputting international characters. (comment out if using XeTeX or LuaTeX)
...
\long\def\beginExerciseFull#1\workSection#2{%
